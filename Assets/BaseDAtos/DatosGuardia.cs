...
public class DatosGuardia : MonoBehaviour
{
    ...
    public List<GuardiaNvl> GuardiaNvl_list { get; private set; }
    ...
    public IEnumerator WaitForRequest_Select(UnityWebRequest www)
    {
        ...
        GuardiaNvl[] guardia = JsonConvert.DeserializeObject<GuardiaNvl[]>(JsonStringHP);
        GuardiaNvl_list = new List<GuardiaNvl>(guardia);
      
        Mejorar.nivelGuardia = GuardiaNvl_list[0].nivelGuardia;
        AcualizarDinero.textValue = Mejorar.dineroAhora.ToString();
       
        Mejorar.mejoraGuardia();
       AcualizarDinero.textG = Mejorar.dineronecesitado.ToString();
