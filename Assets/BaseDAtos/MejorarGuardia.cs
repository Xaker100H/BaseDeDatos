...
public class MejorarGuardia : MonoBehaviour
{
    ...
    [Header("User Read")]
    public List<GuardiaNvl> GuardiaNvl_list = new List<GuardiaNvl>();
    ...
    public void Read()
    {
        ...
        Debug.Log("http://" + "localhost" + ":" + puerto + "/towerInvasion/" + consulta + "?_idUser=" + GuardarMensaje.inputUser + "&_DineroNecesitado=" + Mejorar.dineronecesitado);
